...
// IWYU pragma: private, include "yesense_interface/msg/quat.h"


#ifndef YESENSE_INTERFACE__MSG__DETAIL__QUAT__FUNCTIONS_H_
#define YESENSE_INTERFACE__MSG__DETAIL__QUAT__FUNCTIONS_H_
 ...
 * calls
 * yesense_interface__msg__Quat__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_yesense_interface
yesense_interface__msg__Quat *
yesense_interface__msg__Quat__create(void);

/// Destroy msg/Quat message.
/**
 * It calls
 * yesense_interface__msg__Quat__fini()
 ...
 * yesense_interface__msg__Quat__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * yesense_interface__msg__Quat__Sequence__fini()
 * on the array,
...
#endif  // YESENSE_INTERFACE__MSG__DETAIL__QUAT__FUNCTIONS_H_
