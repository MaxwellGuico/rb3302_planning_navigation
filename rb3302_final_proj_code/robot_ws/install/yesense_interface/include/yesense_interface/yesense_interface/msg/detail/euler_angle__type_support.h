...
#ifndef YESENSE_INTERFACE__MSG__DETAIL__EULER_ANGLE__TYPE_SUPPORT_H_
#define YESENSE_INTERFACE__MSG__DETAIL__EULER_ANGLE__TYPE_SUPPORT_H_
...
#endif  // YESENSE_INTERFACE__MSG__DETAIL__EULER_ANGLE__TYPE_SUPPORT_H_
