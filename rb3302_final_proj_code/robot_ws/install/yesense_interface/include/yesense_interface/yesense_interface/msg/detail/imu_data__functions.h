...
// IWYU pragma: private, include "yesense_interface/msg/imu_data.h"


#ifndef YESENSE_INTERFACE__MSG__DETAIL__IMU_DATA__FUNCTIONS_H_
#define YESENSE_INTERFACE__MSG__DETAIL__IMU_DATA__FUNCTIONS_H_
 ...
 * calls
 * yesense_interface__msg__ImuData__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_yesense_interface
yesense_interface__msg__ImuData *
yesense_interface__msg__ImuData__create(void);

/// Destroy msg/ImuData message.
/**
 * It calls
 * yesense_interface__msg__ImuData__fini()
 ...
 * yesense_interface__msg__ImuData__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * yesense_interface__msg__ImuData__Sequence__fini()
 * on the array,
...
#endif  // YESENSE_INTERFACE__MSG__DETAIL__IMU_DATA__FUNCTIONS_H_
