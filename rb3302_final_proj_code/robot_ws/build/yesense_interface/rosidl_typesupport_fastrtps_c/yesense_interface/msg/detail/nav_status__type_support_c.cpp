  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const yesense_interface__msg__NavStatus * ros_message = static_cast<const yesense_interface__msg__NavStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_yesense_interface__msg__NavStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  yesense_interface__msg__NavStatus * ros_message = static_cast<yesense_interface__msg__NavStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_yesense_interface__msg__NavStatus(cdr, ros_message);
}
