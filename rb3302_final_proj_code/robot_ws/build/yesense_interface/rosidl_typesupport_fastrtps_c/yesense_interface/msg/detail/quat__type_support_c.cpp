...
#include "yesense_interface/msg/detail/quat__rosidl_typesupport_fastrtps_c.h"
...
using _Quat__ros_msg_type = yesense_interface__msg__Quat;
...
{
  const _Quat__ros_msg_type * ros_message = static_cast<const _Quat__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yesense_interface__msg__Quat;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const yesense_interface__msg__Quat * ros_message = static_cast<const yesense_interface__msg__Quat *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_yesense_interface__msg__Quat(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  yesense_interface__msg__Quat * ros_message = static_cast<yesense_interface__msg__Quat *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_yesense_interface__msg__Quat(cdr, ros_message);
}

static uint32_t _Quat__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yesense_interface__msg__Quat(
...
static size_t _Quat__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yesense_interface__msg__Quat(
...
static message_type_support_callbacks_t __callbacks_Quat = {
...
static rosidl_message_type_support_t _Quat__type_support = {
