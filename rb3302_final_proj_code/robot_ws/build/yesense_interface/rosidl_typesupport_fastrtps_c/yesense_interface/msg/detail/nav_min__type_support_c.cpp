...
bool cdr_serialize_yesense_interface__msg__PosOnly(
  const yesense_interface__msg__PosOnly * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_yesense_interface__msg__PosOnly(
  eprosima::fastcdr::Cdr & cdr,
  yesense_interface__msg__PosOnly * ros_message);
...
bool cdr_serialize_key_yesense_interface__msg__PosOnly(
  const yesense_interface__msg__PosOnly * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_yesense_interface__msg__PosOnly(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_yesense_interface__msg__PosOnly(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: pos
  {
    cdr_serialize_yesense_interface__msg__PosOnly(
      &ros_message->pos, cdr);
  }
  ...
  yesense_interface__msg__NavMin * ros_message)
{
  // Field name: pos
  {
    cdr_deserialize_yesense_interface__msg__PosOnly(cdr, &ros_message->pos);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: pos
  {
    cdr_serialize_key_yesense_interface__msg__PosOnly(
      &ros_message->pos, cdr);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: pos
  current_alignment += get_serialized_size_key_yesense_interface__msg__PosOnly(
    &(ros_message->pos), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: pos
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_yesense_interface__msg__PosOnly(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const yesense_interface__msg__NavMin * ros_message = static_cast<const yesense_interface__msg__NavMin *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_yesense_interface__msg__NavMin(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  yesense_interface__msg__NavMin * ros_message = static_cast<yesense_interface__msg__NavMin *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_yesense_interface__msg__NavMin(cdr, ros_message);
}
