...
#include "yesense_interface/msg/detail/robot_lord__rosidl_typesupport_fastrtps_c.h"
...
using _RobotLord__ros_msg_type = yesense_interface__msg__RobotLord;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yesense_interface
bool cdr_serialize_yesense_interface__msg__RobotLord(
  const yesense_interface__msg__RobotLord * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: tid
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yesense_interface
bool cdr_deserialize_yesense_interface__msg__RobotLord(
  eprosima::fastcdr::Cdr & cdr,
  yesense_interface__msg__RobotLord * ros_message)
{
  // Field name: tid
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yesense_interface
size_t get_serialized_size_yesense_interface__msg__RobotLord(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotLord__ros_msg_type * ros_message = static_cast<const _RobotLord__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yesense_interface
size_t max_serialized_size_yesense_interface__msg__RobotLord(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yesense_interface__msg__RobotLord;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yesense_interface
bool cdr_serialize_key_yesense_interface__msg__RobotLord(
  const yesense_interface__msg__RobotLord * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: tid
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yesense_interface
size_t get_serialized_size_key_yesense_interface__msg__RobotLord(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotLord__ros_msg_type * ros_message = static_cast<const _RobotLord__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yesense_interface
size_t max_serialized_size_key_yesense_interface__msg__RobotLord(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const yesense_interface__msg__RobotLord * ros_message = static_cast<const yesense_interface__msg__RobotLord *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_yesense_interface__msg__RobotLord(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  yesense_interface__msg__RobotLord * ros_message = static_cast<yesense_interface__msg__RobotLord *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_yesense_interface__msg__RobotLord(cdr, ros_message);
}

static uint32_t _RobotLord__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yesense_interface__msg__RobotLord(
...
static size_t _RobotLord__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yesense_interface__msg__RobotLord(
...
static message_type_support_callbacks_t __callbacks_RobotLord = {
...
static rosidl_message_type_support_t _RobotLord__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RobotLord,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yesense_interface, msg, RobotLord)() {
  return &_RobotLord__type_support;
}
