...
bool cdr_serialize_yesense_interface__msg__AttitudeMinAhrs(
  const yesense_interface__msg__AttitudeMinAhrs * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_yesense_interface__msg__AttitudeMinAhrs(
  eprosima::fastcdr::Cdr & cdr,
  yesense_interface__msg__AttitudeMinAhrs * ros_message);
...
bool cdr_serialize_key_yesense_interface__msg__AttitudeMinAhrs(
  const yesense_interface__msg__AttitudeMinAhrs * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_yesense_interface__msg__AttitudeMinAhrs(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_yesense_interface__msg__AttitudeMinAhrs(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_yesense_interface__msg__AttitudeAllData(
  const yesense_interface__msg__AttitudeAllData * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: att_min_ahrs
  {
    cdr_serialize_yesense_interface__msg__AttitudeMinAhrs(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yesense_interface
bool cdr_deserialize_yesense_interface__msg__AttitudeAllData(
  eprosima::fastcdr::Cdr & cdr,
  yesense_interface__msg__AttitudeAllData * ros_message)
{
  // Field name: att_min_ahrs
  {
    cdr_deserialize_yesense_interface__msg__AttitudeMinAhrs(cdr, &ros_message->att_min_ahrs);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yesense_interface
bool cdr_serialize_key_yesense_interface__msg__AttitudeAllData(
  const yesense_interface__msg__AttitudeAllData * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: att_min_ahrs
  {
    cdr_serialize_key_yesense_interface__msg__AttitudeMinAhrs(
      &ros_message->att_min_ahrs, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yesense_interface
size_t get_serialized_size_key_yesense_interface__msg__AttitudeAllData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AttitudeAllData__ros_msg_type * ros_message = static_cast<const _AttitudeAllData__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: att_min_ahrs
  current_alignment += get_serialized_size_key_yesense_interface__msg__AttitudeMinAhrs(
    &(ros_message->att_min_ahrs), current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yesense_interface
size_t max_serialized_size_key_yesense_interface__msg__AttitudeAllData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: att_min_ahrs
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_yesense_interface__msg__AttitudeMinAhrs(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const yesense_interface__msg__AttitudeAllData * ros_message = static_cast<const yesense_interface__msg__AttitudeAllData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_yesense_interface__msg__AttitudeAllData(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  yesense_interface__msg__AttitudeAllData * ros_message = static_cast<yesense_interface__msg__AttitudeAllData *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_yesense_interface__msg__AttitudeAllData(cdr, ros_message);
}
