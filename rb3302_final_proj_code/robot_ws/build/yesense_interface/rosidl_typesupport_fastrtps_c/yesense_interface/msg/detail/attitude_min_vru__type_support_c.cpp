...
#include "yesense_interface/msg/detail/attitude_min_vru__rosidl_typesupport_fastrtps_c.h"
...
using _AttitudeMinVru__ros_msg_type = yesense_interface__msg__AttitudeMinVru;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yesense_interface
bool cdr_serialize_yesense_interface__msg__AttitudeMinVru(
  const yesense_interface__msg__AttitudeMinVru * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yesense_interface
bool cdr_deserialize_yesense_interface__msg__AttitudeMinVru(
  eprosima::fastcdr::Cdr & cdr,
  yesense_interface__msg__AttitudeMinVru * ros_message)
{
  // Field name: imu_basic
  {
...
size_t get_serialized_size_yesense_interface__msg__AttitudeMinVru(
  ...
  size_t current_alignment)
{
  const _AttitudeMinVru__ros_msg_type * ros_message = static_cast<const _AttitudeMinVru__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yesense_interface__msg__AttitudeMinVru;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yesense_interface
bool cdr_serialize_key_yesense_interface__msg__AttitudeMinVru(
  const yesense_interface__msg__AttitudeMinVru * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: imu_basic
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yesense_interface
size_t get_serialized_size_key_yesense_interface__msg__AttitudeMinVru(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AttitudeMinVru__ros_msg_type * ros_message = static_cast<const _AttitudeMinVru__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_yesense_interface
size_t max_serialized_size_key_yesense_interface__msg__AttitudeMinVru(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const yesense_interface__msg__AttitudeMinVru * ros_message = static_cast<const yesense_interface__msg__AttitudeMinVru *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_yesense_interface__msg__AttitudeMinVru(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  yesense_interface__msg__AttitudeMinVru * ros_message = static_cast<yesense_interface__msg__AttitudeMinVru *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_yesense_interface__msg__AttitudeMinVru(cdr, ros_message);
}

static uint32_t _AttitudeMinVru__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yesense_interface__msg__AttitudeMinVru(
...
static size_t _AttitudeMinVru__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yesense_interface__msg__AttitudeMinVru(
...
static message_type_support_callbacks_t __callbacks_AttitudeMinVru = {
...
static rosidl_message_type_support_t _AttitudeMinVru__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AttitudeMinVru,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yesense_interface, msg, AttitudeMinVru)() {
  return &_AttitudeMinVru__type_support;
}
