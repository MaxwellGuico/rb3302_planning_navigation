...
static const _NavMin_type_support_symbol_names_t _NavMin_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yesense_interface, msg, NavMin)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yesense_interface, msg, NavMin)),
  }
};
...
{
  return &::yesense_interface::msg::rosidl_typesupport_cpp::NavMin_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, yesense_interface, msg, NavMin)() {
  return get_message_type_support_handle<yesense_interface::msg::NavMin>();
}
