...
{
  new (message_memory) yesense_interface::msg::Vel(_init);
}

void Vel_fini_function(void * message_memory)
{
  auto typed_message = static_cast<yesense_interface::msg::Vel *>(message_memory);
  typed_message->~Vel();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Vel_message_member_array[3] = {
  {
    ...
    offsetof(yesense_interface::msg::Vel, vel_e),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yesense_interface::msg::Vel, vel_n),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(yesense_interface::msg::Vel, vel_u),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Vel_message_members = {
  ...
  "Vel",  // message name
  3,  // number of fields
  sizeof(yesense_interface::msg::Vel),
...
{
  return &::yesense_interface::msg::rosidl_typesupport_introspection_cpp::Vel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yesense_interface, msg, Vel)() {
  return &::yesense_interface::msg::rosidl_typesupport_introspection_cpp::Vel_message_type_support_handle;
}
