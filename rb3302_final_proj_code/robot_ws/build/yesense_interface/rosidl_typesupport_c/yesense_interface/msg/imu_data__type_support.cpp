...
#include "yesense_interface/msg/detail/imu_data__type_support.h"
...
static const _ImuData_type_support_symbol_names_t _ImuData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yesense_interface, msg, ImuData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, yesense_interface, msg, ImuData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, yesense_interface, msg, ImuData)() {
  return &::yesense_interface::msg::rosidl_typesupport_c::ImuData_message_type_support_handle;
}
