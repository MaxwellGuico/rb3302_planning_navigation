...
yesense_interface__msg__GnssPos__create(void)
{
...
yesense_interface__msg__GnssPos__Sequence__init(yesense_interface__msg__GnssPos__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(yesense_interface__msg__GnssPos)) {
      return false;
    }
  ...
  yesense_interface__msg__GnssPos__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(yesense_interface__msg__GnssPos)) {
      return false;
    }
