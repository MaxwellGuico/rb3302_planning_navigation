...
yesense_interface__msg__RobotLord__init(yesense_interface__msg__RobotLord * msg)
{
  ...
  if (!yesense_interface__msg__Tid__init(&msg->tid)) {
    yesense_interface__msg__RobotLord__fini(msg);
    return false;
  }
  // acc
...
yesense_interface__msg__RobotLord__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yesense_interface__msg__RobotLord * msg = (yesense_interface__msg__RobotLord *)allocator.allocate(sizeof(yesense_interface__msg__RobotLord), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(yesense_interface__msg__RobotLord));
  bool success = yesense_interface__msg__RobotLord__init(msg);
  if (!success) {
...
yesense_interface__msg__RobotLord__Sequence__init(yesense_interface__msg__RobotLord__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yesense_interface__msg__RobotLord * data = NULL;

  if (size) {
    if (size > SIZE_MAX / sizeof(yesense_interface__msg__RobotLord)) {
      return false;
    }
    data = (yesense_interface__msg__RobotLord *)allocator.zero_allocate(size, sizeof(yesense_interface__msg__RobotLord), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = yesense_interface__msg__RobotLord__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        yesense_interface__msg__RobotLord__fini(&data[i - 1]);
      }
...
yesense_interface__msg__RobotLord__Sequence__fini(yesense_interface__msg__RobotLord__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      yesense_interface__msg__RobotLord__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  yesense_interface__msg__RobotLord__Sequence * array = (yesense_interface__msg__RobotLord__Sequence *)allocator.allocate(sizeof(yesense_interface__msg__RobotLord__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = yesense_interface__msg__RobotLord__Sequence__init(array, size);
  if (!success) {
...
yesense_interface__msg__RobotLord__Sequence__destroy(yesense_interface__msg__RobotLord__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    yesense_interface__msg__RobotLord__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
yesense_interface__msg__RobotLord__Sequence__are_equal(const yesense_interface__msg__RobotLord__Sequence * lhs, const yesense_interface__msg__RobotLord__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!yesense_interface__msg__RobotLord__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  yesense_interface__msg__RobotLord__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(yesense_interface__msg__RobotLord)) {
      return false;
    }
    const size_t allocation_size =
      input->size * sizeof(yesense_interface__msg__RobotLord);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    yesense_interface__msg__RobotLord * data =
      (yesense_interface__msg__RobotLord *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!yesense_interface__msg__RobotLord__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          yesense_interface__msg__RobotLord__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!yesense_interface__msg__RobotLord__copy(
