...
yesense_interface__msg__ThreeAxis__create(void)
{
...
yesense_interface__msg__ThreeAxis__Sequence__init(yesense_interface__msg__ThreeAxis__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(yesense_interface__msg__ThreeAxis)) {
      return false;
    }
  ...
  yesense_interface__msg__ThreeAxis__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(yesense_interface__msg__ThreeAxis)) {
      return false;
    }
