...
static char yesense_interface__msg__AttitudeMinVru__FIELD_NAME__imu_basic[] = "imu_basic";
static char yesense_interface__msg__AttitudeMinVru__FIELD_NAME__euler[] = "euler";

static rosidl_runtime_c__type_description__Field yesense_interface__msg__AttitudeMinVru__FIELDS[] = {
  {
    {yesense_interface__msg__AttitudeMinVru__FIELD_NAME__imu_basic, 9, 9},
    {
  ...
  {
    {yesense_interface__msg__AttitudeMinVru__FIELD_NAME__euler, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription yesense_interface__msg__AttitudeMinVru__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {yesense_interface__msg__EulerAngle__TYPE_NAME, 32, 32},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {yesense_interface__msg__AttitudeMinVru__FIELDS, 2, 2},
    },
    {yesense_interface__msg__AttitudeMinVru__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[1].fields = yesense_interface__msg__ImuData__get_type_description(NULL)->type_description.fields;
...
yesense_interface__msg__AttitudeMinVru__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *yesense_interface__msg__AttitudeMinVru__get_individual_type_description_source(NULL),
    sources[1] = *yesense_interface__msg__EulerAngle__get_individual_type_description_source(NULL);
    sources[2] = *yesense_interface__msg__ImuData__get_individual_type_description_source(NULL);
