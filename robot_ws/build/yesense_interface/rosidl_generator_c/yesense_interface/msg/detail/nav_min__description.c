...
static char yesense_interface__msg__NavMin__FIELD_NAME__pos[] = "pos";
static char yesense_interface__msg__NavMin__FIELD_NAME__euler[] = "euler";

static rosidl_runtime_c__type_description__Field yesense_interface__msg__NavMin__FIELDS[] = {
  {
    {yesense_interface__msg__NavMin__FIELD_NAME__pos, 3, 3},
    {
  ...
  {
    {yesense_interface__msg__NavMin__FIELD_NAME__euler, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription yesense_interface__msg__NavMin__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {yesense_interface__msg__EulerAngle__TYPE_NAME, 32, 32},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {yesense_interface__msg__NavMin__FIELDS, 2, 2},
    },
    {yesense_interface__msg__NavMin__REFERENCED_TYPE_DESCRIPTIONS, 5, 5},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[3].fields = yesense_interface__msg__PosOnly__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[4].fields = yesense_interface__msg__Tid__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
yesense_interface__msg__NavMin__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *yesense_interface__msg__NavMin__get_individual_type_description_source(NULL),
    ...
    sources[4] = *yesense_interface__msg__PosOnly__get_individual_type_description_source(NULL);
    sources[5] = *yesense_interface__msg__Tid__get_individual_type_description_source(NULL);
    constructed = true;
  }
