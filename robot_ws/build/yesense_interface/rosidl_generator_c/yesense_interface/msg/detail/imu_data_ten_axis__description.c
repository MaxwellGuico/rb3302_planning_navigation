  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x0b, 0x60, 0xd6, 0x0c, 0x05, 0x36, 0xc7, 0x6d,
      0x3a, 0x55, 0x91, 0x0d, 0xd8, 0x31, 0x28, 0xb1,
      0xf2, 0x27, 0x27, 0xff, 0xf4, 0xea, 0x09, 0xe0,
      0xa5, 0x61, 0x3f, 0xc7, 0x57, 0x7f, 0x10, 0x9c,
    }};
  return &hash;
}
...
static char yesense_interface__msg__ImuDataTenAxis__TYPE_NAME[] = "yesense_interface/msg/ImuDataTenAxis";
...
static char yesense_interface__msg__ImuDataTenAxis__FIELD_NAME__imu_basic[] = "imu_basic";
static char yesense_interface__msg__ImuDataTenAxis__FIELD_NAME__mag_norm[] = "mag_norm";
static char yesense_interface__msg__ImuDataTenAxis__FIELD_NAME__mag_raw[] = "mag_raw";
static char yesense_interface__msg__ImuDataTenAxis__FIELD_NAME__pressure[] = "pressure";

static rosidl_runtime_c__type_description__Field yesense_interface__msg__ImuDataTenAxis__FIELDS[] = {
  {
    {yesense_interface__msg__ImuDataTenAxis__FIELD_NAME__imu_basic, 9, 9},
    {
  ...
  {
    {yesense_interface__msg__ImuDataTenAxis__FIELD_NAME__mag_norm, 8, 8},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {yesense_interface__msg__ImuDataTenAxis__FIELD_NAME__mag_raw, 7, 7},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {yesense_interface__msg__ImuDataTenAxis__FIELD_NAME__pressure, 8, 8},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription yesense_interface__msg__ImuDataTenAxis__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {yesense_interface__msg__ImuData__TYPE_NAME, 29, 29},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {yesense_interface__msg__ImuDataTenAxis__TYPE_NAME, 36, 36},
      {yesense_interface__msg__ImuDataTenAxis__FIELDS, 4, 4},
    },
    {yesense_interface__msg__ImuDataTenAxis__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[0].fields = yesense_interface__msg__ImuData__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[1].fields = yesense_interface__msg__Pressure__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[2].fields = yesense_interface__msg__SampleTimestamp__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[3].fields = yesense_interface__msg__SensorTemp__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[4].fields = yesense_interface__msg__ThreeAxis__get_type_description(NULL)->type_description.fields;
...
static char toplevel_type_raw_source[] =
  "yesense_interface/ImuData\\t\\t\\timu_basic\n"
...
yesense_interface__msg__ImuDataTenAxis__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *yesense_interface__msg__ImuDataTenAxis__get_individual_type_description_source(NULL),
    sources[1] = *yesense_interface__msg__ImuData__get_individual_type_description_source(NULL);
    sources[2] = *yesense_interface__msg__Pressure__get_individual_type_description_source(NULL);
    sources[3] = *yesense_interface__msg__SampleTimestamp__get_individual_type_description_source(NULL);
    sources[4] = *yesense_interface__msg__SensorTemp__get_individual_type_description_source(NULL);
    sources[5] = *yesense_interface__msg__ThreeAxis__get_individual_type_description_source(NULL);
