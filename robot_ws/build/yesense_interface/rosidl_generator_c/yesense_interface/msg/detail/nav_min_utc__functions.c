...
yesense_interface__msg__NavMinUtc__create(void)
{
...
yesense_interface__msg__NavMinUtc__Sequence__init(yesense_interface__msg__NavMinUtc__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(yesense_interface__msg__NavMinUtc)) {
      return false;
    }
  ...
  yesense_interface__msg__NavMinUtc__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(yesense_interface__msg__NavMinUtc)) {
      return false;
    }
