...
// IWYU pragma: private, include "yesense_interface/msg/pos_only.h"


#ifndef YESENSE_INTERFACE__MSG__DETAIL__POS_ONLY__FUNCTIONS_H_
#define YESENSE_INTERFACE__MSG__DETAIL__POS_ONLY__FUNCTIONS_H_
...
/// Initialize msg/PosOnly message.
/**
...
/// Create msg/PosOnly message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * yesense_interface__msg__PosOnly__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_yesense_interface
yesense_interface__msg__PosOnly *
yesense_interface__msg__PosOnly__create(void);

/// Destroy msg/PosOnly message.
/**
 * It calls
 * yesense_interface__msg__PosOnly__fini()
...
/// Check for msg/PosOnly message equality.
/**
...
/// Initialize array of msg/PosOnly messages.
/**
...
/// Finalize array of msg/PosOnly messages.
/**
 * It calls
 * yesense_interface__msg__PosOnly__fini()
...
/// Create array of msg/PosOnly messages.
/**
 * It allocates the memory for the array and calls
 * yesense_interface__msg__PosOnly__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of msg/PosOnly messages.
/**
 * It calls
 * yesense_interface__msg__PosOnly__Sequence__fini()
 * on the array,
...
/// Check for msg/PosOnly message array equality.
/**
...
/// Copy an array of msg/PosOnly messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
...
#endif  // YESENSE_INTERFACE__MSG__DETAIL__POS_ONLY__FUNCTIONS_H_
