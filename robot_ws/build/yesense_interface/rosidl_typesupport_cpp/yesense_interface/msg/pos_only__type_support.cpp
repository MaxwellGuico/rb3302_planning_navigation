...
static const _PosOnly_type_support_symbol_names_t _PosOnly_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yesense_interface, msg, PosOnly)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yesense_interface, msg, PosOnly)),
  }
};
...
{
  return &::yesense_interface::msg::rosidl_typesupport_cpp::PosOnly_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, yesense_interface, msg, PosOnly)() {
  return get_message_type_support_handle<yesense_interface::msg::PosOnly>();
}
