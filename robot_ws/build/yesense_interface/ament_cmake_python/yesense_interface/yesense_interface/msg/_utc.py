...
class Metaclass_Utc(type):
    """Metaclass of message 'Utc'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__utc
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__utc
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__utc
            cls._TYPE_SUPPORT = module.type_support_msg__msg__utc
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__utc
...
class Utc(metaclass=Metaclass_Utc):
    """Message class 'Utc'."""
    ...
    def ms(self, value):
        if self._check_fields:
            ...
            assert value >= 0 and value < 4294967296, \
                "The 'ms' field must be an unsigned integer in [0, 4294967295]"
        self._ms = value
