  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr_serialize_yesense_interface__msg__AttitudeMinVru(
  ...
  yesense_interface__msg__AttitudeMinAhrs * ros_message)
{
  // Field name: att_min_vru
  {
    cdr_deserialize_yesense_interface__msg__AttitudeMinVru(cdr, &ros_message->att_min_vru);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: att_min_vru
  {
    cdr_serialize_key_yesense_interface__msg__AttitudeMinVru(
      &ros_message->att_min_vru, cdr);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: att_min_vru
  current_alignment += get_serialized_size_key_yesense_interface__msg__AttitudeMinVru(
    &(ros_message->att_min_vru), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: att_min_vru
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_yesense_interface__msg__AttitudeMinVru(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const yesense_interface__msg__AttitudeMinAhrs * ros_message = static_cast<const yesense_interface__msg__AttitudeMinAhrs *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_yesense_interface__msg__AttitudeMinAhrs(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  yesense_interface__msg__AttitudeMinAhrs * ros_message = static_cast<yesense_interface__msg__AttitudeMinAhrs *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_yesense_interface__msg__AttitudeMinAhrs(cdr, ros_message);
}
