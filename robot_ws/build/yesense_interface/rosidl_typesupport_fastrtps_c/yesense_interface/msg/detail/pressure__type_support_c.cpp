...
#include "yesense_interface/msg/detail/pressure__rosidl_typesupport_fastrtps_c.h"
...
using _Pressure__ros_msg_type = yesense_interface__msg__Pressure;
...
{
  const _Pressure__ros_msg_type * ros_message = static_cast<const _Pressure__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yesense_interface__msg__Pressure;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const yesense_interface__msg__Pressure * ros_message = static_cast<const yesense_interface__msg__Pressure *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_yesense_interface__msg__Pressure(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  yesense_interface__msg__Pressure * ros_message = static_cast<yesense_interface__msg__Pressure *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_yesense_interface__msg__Pressure(cdr, ros_message);
}

static uint32_t _Pressure__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yesense_interface__msg__Pressure(
...
static size_t _Pressure__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yesense_interface__msg__Pressure(
...
static message_type_support_callbacks_t __callbacks_Pressure = {
...
static rosidl_message_type_support_t _Pressure__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Pressure,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, yesense_interface, msg, Pressure)() {
  return &_Pressure__type_support;
}
