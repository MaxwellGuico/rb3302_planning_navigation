...
#include "yesense_interface/msg/detail/pos_only__rosidl_typesupport_fastrtps_c.h"
...
using _PosOnly__ros_msg_type = yesense_interface__msg__PosOnly;
...
size_t get_serialized_size_yesense_interface__msg__PosOnly(
  ...
  size_t current_alignment)
{
  const _PosOnly__ros_msg_type * ros_message = static_cast<const _PosOnly__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yesense_interface__msg__PosOnly;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const yesense_interface__msg__PosOnly * ros_message = static_cast<const yesense_interface__msg__PosOnly *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_yesense_interface__msg__PosOnly(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  yesense_interface__msg__PosOnly * ros_message = static_cast<yesense_interface__msg__PosOnly *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_yesense_interface__msg__PosOnly(cdr, ros_message);
}

static uint32_t _PosOnly__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yesense_interface__msg__PosOnly(
...
static size_t _PosOnly__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yesense_interface__msg__PosOnly(
...
static message_type_support_callbacks_t __callbacks_PosOnly = {
...
static rosidl_message_type_support_t _PosOnly__type_support = {
