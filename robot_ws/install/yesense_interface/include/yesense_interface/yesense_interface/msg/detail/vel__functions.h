...
// IWYU pragma: private, include "yesense_interface/msg/vel.h"


#ifndef YESENSE_INTERFACE__MSG__DETAIL__VEL__FUNCTIONS_H_
#define YESENSE_INTERFACE__MSG__DETAIL__VEL__FUNCTIONS_H_
 ...
 * calls
 * yesense_interface__msg__Vel__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_yesense_interface
yesense_interface__msg__Vel *
yesense_interface__msg__Vel__create(void);

/// Destroy msg/Vel message.
/**
 * It calls
 * yesense_interface__msg__Vel__fini()
 ...
 * yesense_interface__msg__Vel__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * yesense_interface__msg__Vel__Sequence__fini()
 * on the array,
...
#endif  // YESENSE_INTERFACE__MSG__DETAIL__VEL__FUNCTIONS_H_
