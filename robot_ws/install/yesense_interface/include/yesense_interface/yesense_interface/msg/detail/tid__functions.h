...
// IWYU pragma: private, include "yesense_interface/msg/tid.h"


#ifndef YESENSE_INTERFACE__MSG__DETAIL__TID__FUNCTIONS_H_
#define YESENSE_INTERFACE__MSG__DETAIL__TID__FUNCTIONS_H_
...
/// Create msg/Tid message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * yesense_interface__msg__Tid__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_yesense_interface
yesense_interface__msg__Tid *
yesense_interface__msg__Tid__create(void);

/// Destroy msg/Tid message.
/**
 * It calls
 * yesense_interface__msg__Tid__fini()
...
/// Check for msg/Tid message equality.
/**
...
/// Initialize array of msg/Tid messages.
/**
...
/// Finalize array of msg/Tid messages.
/**
 * It calls
 * yesense_interface__msg__Tid__fini()
...
/// Create array of msg/Tid messages.
/**
 * It allocates the memory for the array and calls
 * yesense_interface__msg__Tid__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of msg/Tid messages.
/**
 * It calls
 * yesense_interface__msg__Tid__Sequence__fini()
 * on the array,
...
/// Check for msg/Tid message array equality.
/**
...
/// Copy an array of msg/Tid messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
...
#endif  // YESENSE_INTERFACE__MSG__DETAIL__TID__FUNCTIONS_H_
