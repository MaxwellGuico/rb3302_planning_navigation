...
// IWYU pragma: private, include "yesense_interface/msg/nav_status.h"


#ifndef YESENSE_INTERFACE__MSG__DETAIL__NAV_STATUS__FUNCTIONS_H_
#define YESENSE_INTERFACE__MSG__DETAIL__NAV_STATUS__FUNCTIONS_H_
 ...
 * calls
 * yesense_interface__msg__NavStatus__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_yesense_interface
yesense_interface__msg__NavStatus *
yesense_interface__msg__NavStatus__create(void);

/// Destroy msg/NavStatus message.
/**
 * It calls
 * yesense_interface__msg__NavStatus__fini()
 ...
 * yesense_interface__msg__NavStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * yesense_interface__msg__NavStatus__Sequence__fini()
 * on the array,
...
#endif  // YESENSE_INTERFACE__MSG__DETAIL__NAV_STATUS__FUNCTIONS_H_
