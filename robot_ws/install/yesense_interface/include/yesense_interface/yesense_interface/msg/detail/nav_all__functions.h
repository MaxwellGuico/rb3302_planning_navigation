...
// IWYU pragma: private, include "yesense_interface/msg/nav_all.h"


#ifndef YESENSE_INTERFACE__MSG__DETAIL__NAV_ALL__FUNCTIONS_H_
#define YESENSE_INTERFACE__MSG__DETAIL__NAV_ALL__FUNCTIONS_H_
...
/// Create msg/NavAll message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * yesense_interface__msg__NavAll__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_yesense_interface
yesense_interface__msg__NavAll *
yesense_interface__msg__NavAll__create(void);

/// Destroy msg/NavAll message.
/**
 * It calls
 * yesense_interface__msg__NavAll__fini()
...
/// Check for msg/NavAll message equality.
/**
...
/// Initialize array of msg/NavAll messages.
/**
...
/// Finalize array of msg/NavAll messages.
/**
 * It calls
 * yesense_interface__msg__NavAll__fini()
...
/// Create array of msg/NavAll messages.
/**
 * It allocates the memory for the array and calls
 * yesense_interface__msg__NavAll__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of msg/NavAll messages.
/**
 * It calls
 * yesense_interface__msg__NavAll__Sequence__fini()
 * on the array,
...
/// Check for msg/NavAll message array equality.
/**
...
/// Copy an array of msg/NavAll messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
...
#endif  // YESENSE_INTERFACE__MSG__DETAIL__NAV_ALL__FUNCTIONS_H_
